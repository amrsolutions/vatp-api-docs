...
```
**Fix:** Invoice ID missing (37) and item name empty (43). See [error codes](./reference/error-codes.md)
...
- 🔍 [Explore all endpoints](./endpoints/)
- 💡 [Check real-world examples](./examples/)
- ⚠️ [Error codes reference](./reference/error-codes.md)

## Need Help?

- Stuck on authentication? → [Authentication Guide](./authentication.md)
- Invoice validation errors? → [Error Codes](./reference/error-codes.md)
